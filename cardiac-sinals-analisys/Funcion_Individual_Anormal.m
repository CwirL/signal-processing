%SE�ALES AUDIOS ANORMALES
%Para probar los demas audias se debe cambiar los vectores limite y
%pos_limite, con los limites de dicho audio
clear all;
clc;
[y1,Fs1] = audioread('audios/e_m63.wav');%revisar e198
info1 = audioinfo('audios/e_m63.wav'); t = 0:seconds(1/Fs1):seconds(info1.Duration); t = t(1:end-1);
...
limite=[t([10 816 2228 2990])];
pos_limite=[10 816 2228 2990];
